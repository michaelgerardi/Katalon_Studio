...
WebUI.click(findTestObject('Page_CURA Healthcare Service/th_March 2020'))

WebUI.click(findTestObject('Page_CURA Healthcare Service/th_2020'))

WebUI.click(findTestObject('Page_CURA Healthcare Service/th_'))

WebUI.click(findTestObject('Page_CURA Healthcare Service/span_2017'))

WebUI.click(findTestObject('Page_CURA Healthcare Service/span_Apr'))

WebUI.click(findTestObject('Page_CURA Healthcare Service/td_30'))

WebUI.setText(findTestObject('Page_CURA Healthcare Service/textarea_Comment_comment'), 'This A moment')
